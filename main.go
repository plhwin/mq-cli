		...
		Commands: []*cli.Command{
			{
				...
				Flags: []cli.Flag{
					...
					&cli.StringFlag{Name: "redisAddr", Aliases: []string{"ra"}, Usage: "redis server address, if want to forward, eg: 127.0.0.1:6379"},
					&cli.StringFlag{Name: "redisPassword", Aliases: []string{"rp"}, Usage: "redis password, if want to forward"},
					&cli.StringFlag{Name: "redisChannel", Aliases: []string{"rc"}, Usage: "redis channel name, if want to forward"},
				},
